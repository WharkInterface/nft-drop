...
function NFTDropPage({ collection }: Props) {
    ...
    const mintNft = () => {
        ...
        const quantity = 1; // how many unique NFTs the user can claim
    ...
    return (
        <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
            ...
            <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
                ...
                {/* Mint Button */}
                <button onClick={mintNft} disabled={loading || claimedSupply === totalSupply?.toNumber() || !address} className='mt-10 h-16 bg-red-600 w-full rounded-full font-bold text-white disabled:bg-gray-400'>
                    {loading ? (
                        <>Loading</>
