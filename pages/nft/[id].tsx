    ...
    <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
        ...
        <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
            ...
            <div className='mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0'>
                ...
                <h1 className='text-3xl font-bold lg:text-5xl lg:font-extrabold'>The Whark Ape Coding Club | NFT Drop</h1>

                <p className='pt-2 text-xl text-green-500'>13 / 21 NFT's claimed</p>
            </div>

            {/* Mint Button */}
            <button className='mt-10 h-16 bg-red-600 w-full rounded-full text-white font-bold'>Mint NFT (0.01 ETH)</button>
        </div>
    </div>
  )
}
